The main contents of this repository is the `script.fountain` file, which contains [fountain.io](http://fountain.io) markup to produce screenplay output for PDF.
